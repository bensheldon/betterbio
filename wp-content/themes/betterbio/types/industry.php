<?php get_header(); ?>
	<div id="content" class="archive">
      ...
      <?php if(is_post_type_archive()): ?>
        <h2 class="title"><?php echo ucfirst($post->post_type); ?></h2>
      <?php endif; ?>
	    ...
	    <div class="clearfloat">
	      <?php while (have_posts()) : the_post(); ?>
	        <div class="tanbox left">
	        	...
	        	<div class="meta">
	        	  <?php the_time(get_option('date_format')); ?> &#150; <?php the_time(); ?> | <?php comments_popup_link(__('No Comment','arthemia'), __('One Comment','arthemia'), __('% Comments','arthemia'));?>
	        	</div>
	        
	          <?php 
	            $width = get_settings ( "cp_thumbWidth_Archive" );
