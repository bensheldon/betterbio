<div id="sidebar">
  <?php $showSpoilers = get_settings ( "cp_catSpoilers" ); ?>
  <?php if ( $showSpoilers != "no" ) { ?>
    <?php
      ...
      foreach ($postcat as $cp_pC ) {
        ...
        <?php if (have_posts()) : ?>
          ...
          <div class="spoiler clearfloat">
	          ...
	          <h3 class="catt-<?php echo $cp_pC; ?>"><a href="/<?php echo $cp_pC; ?>"><?php echo ucfirst($cp_pC); ?> &raquo;</a></h3>
	        	...
	        	<?php
	        	  ...
	        	  while (have_posts()) { the_post();
                    ...
                    <?php the_post_thumbnail("tiny_thumb", array("class" => "left")); ?>
	        			...
	        			<div class="right">
	        			  <a href="/<?php echo $cp_pC; ?>"><?php _e('More articles &raquo;','arthemia');?></a>
	        			</div>
