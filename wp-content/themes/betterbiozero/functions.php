...
/** Tell WordPress to run betterbiozero_setup() when the 'after_setup_theme' hook is run. */
add_action( 'after_setup_theme', 'betterbiozero_setup' );

if ( ! function_exists( 'betterbiozero_setup' ) ):
/**
...
function betterbiozero_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'betterbiozero' ),
		'secondary' => __( 'Secondary Navigation', 'betterbiozero' ),
 ...
 * @since Twenty Ten 1.0
 */
function betterbiozero_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'betterbio_page_menu_args' );
 ...
 */
function the_flexible_excerpt($words = 40, $link_text = 'Continue reading this entry &#187;', $allowed_tags = '', $container = 'p', $smileys = 'no' ) {
